 ...
 * under the License.
 */
package com.phy.zookeeper.curator.mastersel;
...
public class LeaderSelectorCurator
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
            ...
            {
                CuratorFramework    client = CuratorFrameworkFactory.newClient("192.168.201.88:2181", new ExponentialBackoffRetry(1000, 3));
                clients.add(client);
